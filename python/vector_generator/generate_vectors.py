...
def main():
    ...
    util.write_json(output_dir / "hostpubkey_gen_vectors.json", generate_hostpubkey_vectors())
    ...
    util.write_json(output_dir / "participant_step1_vectors.json", generate_participant_step1_vectors())
    util.write_json(output_dir / "participant_step2_vectors.json", generate_participant_step2_vectors())
    util.write_json(output_dir / "participant_finalize_vectors.json", generate_participant_finalize_vectors())
    util.write_json(output_dir / "participant_investigate_vectors.json", generate_participant_investigate_vectors())
    util.write_json(output_dir / "coordinator_step1_vectors.json", generate_coordinator_step1_vectors())
    util.write_json(output_dir / "coordinator_finalize_vectors.json", generate_coordinator_finalize_vectors())
    util.write_json(output_dir / "coordinator_investigate_vectors.json", generate_coordinator_investigate_vectors())
