...
class ParticipantMsg(NamedTuple):
    ...
    def from_bytes_and_n(b: bytes, n: int) -> ParticipantMsg:
        ...
        # Read simpl_pmsg
        simpl_pmsg = simplpedpop.ParticipantMsg.from_bytes(rest) # ValueError if len(rest) is incorrect
...
class CoordinatorMsg(NamedTuple):
    ...
    def from_bytes_and_n(b: bytes, n: int) -> CoordinatorMsg:
        ...
        # Read simpl_cmsg
        simpl_cmsg = simplpedpop.CoordinatorMsg.from_bytes_and_n(rest, n) # ValueError if len(rest) is incorrect
